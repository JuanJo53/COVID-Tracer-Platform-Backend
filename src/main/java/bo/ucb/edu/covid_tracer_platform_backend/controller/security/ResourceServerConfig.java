package bo.ucb.edu.covid_tracer_platform_backend.controller.security;
...
public class ResourceServerConfig extends ResourceServerConfigurerAdapter {
    ...
    public void configure(HttpSecurity http) throws Exception {
        http.authorizeRequests()
                ...
                .antMatchers(HttpMethod.GET, "/api/v1/data/country/{isoCountry}/download").hasAnyRole("ADMIN", "USER")
                ...
                .antMatchers(HttpMethod.GET, "/api/v1/data/prediction/**").permitAll()
